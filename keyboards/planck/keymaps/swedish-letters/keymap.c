...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_planck_grid(
    ...
    KC_LCTRL,MT(MOD_HYPR, KC_DELETE),MT(MOD_LALT,KC_INS),KC_LGUI,LOWER,LT(_FN, KC_SPACE),KC_NO,RAISE,LT(_ACCENT, KC_RGUI),MT(MOD_LALT,KC_INS),MT(MOD_HYPR, KC_DELETE),KC_RCTRL),
  ...
  [_RAISE] = LAYOUT_planck_grid(
    ...
    KC_TRANSPARENT,KC_F11,XP(LOWER_ARING,UPPER_ARING),XP(LOWER_ADIER,UPPER_ADIER),XP(LOWER_ODIER,UPPER_ODIER),XP(LOWER_AACUTE,UPPER_AACUTE),XP(LOWER_CCEDIL,UPPER_CCEDIL),KC_CAPSLOCK,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
    KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_NO,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT
    ),
  ...
  [_ACCENT] = LAYOUT_planck_grid(
    KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,XP(LOWER_EACUTE,UPPER_EACUTE),XP(LOWER_ECIRC,UPPER_ECIRC),KC_TRANSPARENT,KC_TRANSPARENT,XP(LOWER_UACUTE,UPPER_UACUTE),XP(LOWER_IACUTE,UPPER_IACUTE),XP(LOWER_OACUTE,UPPER_OACUTE),XP(LOWER_OCIRC,UPPER_OCIRC),KC_TRANSPARENT,
    KC_TRANSPARENT,XP(LOWER_AACUTE,UPPER_AACUTE),XP(LOWER_ACIRC,UPPER_ACIRC),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,XP(LOWER_OTILDE,UPPER_OTILDE),KC_TRANSPARENT,KC_TRANSPARENT,
    KC_TRANSPARENT,XP(LOWER_ATILDE,UPPER_ATILDE),XP(LOWER_AGRAVE,UPPER_AGRAVE),XP(LOWER_CCEDIL,UPPER_CCEDIL),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
    KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_NO,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT
    ),
};
