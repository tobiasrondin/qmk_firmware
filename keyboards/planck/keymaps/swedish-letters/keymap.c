...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_planck_grid(
    KC_TRANSPARENT,KC_TRANSPARENT,JS_CONST,ARROW_FN,KC_GRAVE,KC_TRANSPARENT,KC_TRANSPARENT,KC_BSLASH,KC_EQUAL,KC_LBRACKET,KC_RBRACKET,KC_TRANSPARENT,
    KC_TRANSPARENT,KC_EXLM,KC_AT,KC_HASH,KC_DLR,KC_PERC,KC_CIRC,KC_AMPR,KC_ASTR,KC_LPRN,KC_RPRN,KC_TRANSPARENT,
    KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TILD,KC_TRANSPARENT,KC_TRANSPARENT,KC_PIPE,KC_PLUS,KC_LCBR,KC_RCBR,KC_TRANSPARENT,
  ...
  [_RAISE] = LAYOUT_planck_grid(
    ...
    KC_TRANSPARENT,KC_F11,XP(LITEN1,STOR1),XP(LITEN2,STOR2),XP(LITEN3,STOR3),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
    KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_NO,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT
    ),
